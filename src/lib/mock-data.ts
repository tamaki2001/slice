...
export const mockSlices: Slice[] = [
  ...
  },
  {
    ...
    bookId: "1",
    type: "feedback",
    body: "あなたが「従っているだけの習慣」に目を向けたのは興味深い視点です。ハン・ガンが描く「拒絶」は、アンラーニングの最も原初的な形かもしれません。では、あなた自身が最近「従うのをやめた」ことは何かありますか？それは意識的な選択でしたか、それとも身体が先に動きましたか？",
    persona: "ソクラテス",
    createdAt: "2026-04-07T10:36:00",
  },
  {
    id: "s4",
    bookId: "1",
